...
<html>
<head>
  <title>RumahKu Georgetown</title>
...
<body>
  ...
  <div>
    ...
    <p class="section-title mb-5">RumahKu Georgetown</p>
  ...
  <div id="carouselImg" class="carousel slide" data-bs-ride="carousel">
    ...
    <div class="carousel-inner">
      <div class="carousel-item active">
        <img src="asset/homestay3a.png" class="d-block w-100" alt="...">
      ...
      <div class="carousel-item">
        <img src="asset/homestay3b.png" class="d-block w-100" alt="...">
        <!-- <div class="carousel-caption d-none d-md-block">
      ...
      <div class="carousel-item">
        <img src="asset/homestay3c.png" class="d-block w-100" alt="...">
        <!-- <div class="carousel-caption d-none d-md-block">
...
<div class="homestay-info mt-4 mb-4">
  ...
  <div class="homestay-sipnosis">
    ...
    <p style="font-weight: bold; margin-top: 10px; margin-bottom: 10px; font-family: roboto;">RumahKu Georgetown</p>
    <p> Located in George Town, RumahKu Georgetown offers free WiFi, and guests can enjoy a garden, a shared lounge and a terrace.
There is a shared bathroom with bidet in some units, along with free toiletries, a hairdryer and slippers.
The homestay offers a barbecue.
A bicycle rental service is available at RumahKu Georgetown.
Popular points of interest near the accommodation include 1st Avenue Penang, Rainbow Skywalk at Komtar and Penang Times Square. The nearest airport is Penang International Airport, 14 km from RumahKu Georgetown.</p>
    <p> Other facilities offered at the property include a shared lounge. An array of activities can be enjoyed on site or in the surroundings, including cycling. The property offers free parking.
     ...
     <a href="https://goo.gl/maps/GyhCxfr5ycAcY6Nw8"><p>37, Lebuh Noordin, George Town, 10300 George Town, Pulau Pinang</p></a>
