...
<body>
  ...
  <div>
    ...
    <p class="section-title mb-5">Xcess Penang</p>
  ...
  <div id="carouselImg" class="carousel slide" data-bs-ride="carousel">
    ...
    <div class="carousel-inner">
      <div class="carousel-item active">
        <img src="asset/xcess1.png" class="d-block w-100" alt="...">
      ...
      <div class="carousel-item">
        <img src="asset/xcess2.png" class="d-block w-100" alt="...">
        <!-- <div class="carousel-caption d-none d-md-block">
      ...
      <div class="carousel-item">
        <img src="asset/xcess3.png" class="d-block w-100" alt="...">
        <!-- <div class="carousel-caption d-none d-md-block">
...
Book Xcess Gurney Paragon deserves a mention for its behemoth-like space made of a combined 12 lots across two levels in Gurney Paragon mall. It has a three-storey bookshelf that runs the length of the mall itself, officially the tallest and largest bookshelf in Southeast Asia to date.
  ...
  <div class="gem-contact">
    ...
    <a href="https://goo.gl/maps/u1duamjtb2G2eSNd9"><p style="font-family:  Roboto; color: aliceblue; font-style: italic;">163D-7.06-7.16 & L8.02-8.-5, Gurney Paragon, Persiaran Gurney, 10250 George Town, Pulau Pinang</p></a>
