...
<body>
  ...
  <div>
    ...
    <p class="section-title mb-5">Carnavon House</p>
  ...
  <div id="carouselImg" class="carousel slide" data-bs-ride="carousel">
    ...
    <div class="carousel-inner">
      <div class="carousel-item active">
        <img src="asset/homestay6a.png" class="d-block w-100" alt="...">
      ...
      <div class="carousel-item">
        <img src="asset/homestay6b.png" class="d-block w-100" alt="...">
        <!-- <div class="carousel-caption d-none d-md-block">
      ...
      <div class="carousel-item">
        <img src="asset/homestay6c.png" class="d-block w-100" alt="...">
        <!-- <div class="carousel-caption d-none d-md-block">
...
<div class="homestay-info mt-4 mb-4">
  ...
  <div class="homestay-sipnosis">
    ...
    <p style="font-weight: bold; margin-top: 10px; margin-bottom: 10px; font-family: roboto;">Carnavon House</p>
    <p> Located in George Town, Carnarvon House features a garden, shared lounge, terrace, and free WiFi throughout the property.
       The property is around 2.1 km from Northam Beach, 1 km from Wonderfood Museum and 8.2 km from Straits Quay. The accommodation
        provides room service, a tour desk and luggage storage for guests.The area is popular for cycling, and bike hire and car hire
         are available at the guest house..</p>
    <p> Popular points of interest near Carnarvon House include 1st Avenue Penang, Rainbow Skywalk at Komtar and Penang Times Square.
       The nearest airport is Penang International Airport, 15 km from the accommodation..</p> 

     <p style="font-weight: bold; margin-top: 10px; margin-bottom: 10px; font-family: roboto;">Address</p>

     <a href="https://goo.gl/maps/aSiBQgzmHVxszfgGA"><p>28 Lorong Carnarvon, Georgetown</p></a>
      ...
      <div class="card">
       ...
       <div class="card">
        ...
        <div class="container">
          ...
          <p style="font-family: Roboto ;">Lebuh Sungai Burung 3 Penang, Balik Pulau, Penang</p>
        </div>
      </div>
    </div>
</div>
