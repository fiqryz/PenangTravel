...
<head>
  ...
  <title>Taman Rimba Teluk Bahang</title>
<style>
...
<body>
  ...
  <div>
    ...
    <p class="section-title mb-5">Taman Rimba Teluk Bahang</p>
  ...
  <div id="carouselImg" class="carousel slide" data-bs-ride="carousel">
    ...
    <div class="carousel-inner">
      <div class="carousel-item active">
        <img src="asset/rimba1.png" class="d-block w-100" alt="...">
      ...
      <div class="carousel-item">
        <img src="asset/rimba2.png" class="d-block w-100" alt="...">
        <!-- <div class="carousel-caption d-none d-md-block">
      ...
      <div class="carousel-item">
        <img src="asset/rimba3.png" class="d-block w-100" alt="...">
        <!-- <div class="carousel-caption d-none d-md-block">
...
<div class="gem-info mt-5 mb-5">
  ...
  <div class="gem-contact">
    ...
    <p>8.00 a.m until 6.00 pm</p>

    <p style="font-weight: bold;
    margin-top: 40px; font-family:  Roboto;">Location</p>

    <a href="https://goo.gl/maps/Me2WC3gRmGDai3jB9"><p style="font-family:  Roboto; color: aliceblue; font-style: italic;">Lorong Rimba, Teluk Bahang, 11050 Tanjung Bungah, Pulau Pinang</p></a>
