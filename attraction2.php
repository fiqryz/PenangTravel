...
<head>
  ...
  <title>Aspen City Central Island Park</title>
<style>
...
<body>
  ...
  <div>
    ...
    <p class="section-title mb-5">Aspen City Central Island Park</p>
  ...
  <div id="carouselImg" class="carousel slide" data-bs-ride="carousel">
    ...
    <div class="carousel-inner">
      <div class="carousel-item active">
        <img src="asset/aspen1.png" class="d-block w-100" alt="...">
      ...
      <div class="carousel-item">
        <img src="asset/aspen2.png" class="d-block w-100" alt="...">
        <!-- <div class="carousel-caption d-none d-md-block">
      ...
      <div class="carousel-item">
        <img src="asset/aspen3.png" class="d-block w-100" alt="...">
        <!-- <div class="carousel-caption d-none d-md-block">
...
<div class="gem-info mt-5 mb-5">
  ...
  <div class="gem-sipnosis">
    ...
    <p style="font-weight: bold; margin-top: 30px; margin-bottom: 10px;">Aspen City Central Island Park</p>

    <p style="margin-top: 30px;">People often think of only Ikea when it comes to Batu Kawan. Once they are done with shopping in Ikea Ikano, their mind would be to leave the place with no other attraction in mind.

      Well, within the walking distance of Ikea (in fact, just right next to Ikea!), is a gorgeous park you should NOT miss during your visit to Batu Kawan.
      
      Spanning across 25 acres, Aspen City Central Island Park is a massive green sanctuary located in the midst of Aspen Vision City that serves as a recreational hub for the pursuit of healthy activities and relaxing past-times for all Batu Kawan visitors and residents.
       It is a green oasis in Aspen Vision City and is part of our initiative to nurture nature even as we promote sustainable values within the community.</p>
  ...
  <div class="gem-contact">
    ...
    <p>10.00 a.m until 10.00 pm</p>

    <p style="font-weight: bold;
    margin-top: 40px; font-family:  Roboto;">Location</p>

    <a href="https://goo.gl/maps/Me2WC3gRmGDai3jB9"><p style="font-family:  Roboto; color: aliceblue; font-style: italic;">Aspen Vision City, Lebuhraya Bandar Cassia, 14110, Simpang Ampat</p></a>
